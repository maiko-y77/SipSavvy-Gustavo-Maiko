      ...
      <div className="article-main">
        <div className="article-container">
          {articles.map(({ id, title }) => (
            <div key={id}>
              <p className="article-div">{title}</p>
            </div>
          ))}
            ...
            <div className="related-articles-2">
              <div className="related-article-item">
                ...
                <div className="article-content2">
                  ...
                  <p className="article-preview">
                    Thanks to restaurants’ price gouging tactics, you probably
                    can’t either — There’s something screwed up about a
                    winemaker not being able to ...
                  </p>
                  <div className="author-bullet">
                    <a className="avatar icon" href="/">
                      <UserIcon width={36} height={36} />
              ...
              <div className="related-article-item">
                ...
                <div className="article-content2">
                  ...
                  <p className="article-preview">
                    And why you should drink them too — I call it The
                    Sommelier’s Paradox. It goes like this: The more popular a
                    wine is, the less likely ...
                  </p>
                  <div className="author-bullet">
                    <a className="avatar icon" href="/">
